...
```{r "1_a"}
eu_makro <- read_csv("C:/Users/root/Documents/Projektkurs2/21-22/problem-sets/ps4/data/EU_Makro.csv")
...
```{r "3_a_3"}
dat <- eu_makro %>% filter(country == "Germany" | country == "France" | country == "Netherlands")
